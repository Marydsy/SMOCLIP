...
from .loss_copy import ClipLoss_copy, DistillClipLoss_copy, CoCaLoss_copy, SigLipLoss_copy
from .loss_F import ClipLoss_F,ClipLoss_DCLF
...
def load_checkpoint(
    ...
    #state_dict.pop('logit_bias', None)，siglip训练得到的和model不匹配，删掉logdit_bias
