...
from open_clip import create_model_and_transforms, trace_model, get_tokenizer, create_loss#create_loss指定使用哪个损失函数
from open_clip_train.data import get_data
from open_clip_train.distributed import is_master, init_distributed_device, broadcast_object
from open_clip_train.logger import setup_logging
from open_clip_train.params import parse_args
from open_clip_train.scheduler import cosine_lr, const_lr, const_lr_cooldown
from open_clip_train.train import train_one_epoch, evaluate, evaluate_ensemble
...
def main(args):
    ...
    model1,preprocess_train1,preprocess_val1 =create_model_and_transforms(
        args.model,
        args.pretrained,
        precision=args.precision,
        device=device,
    ...
    model2,preprocess_train2,preprocess_val2= create_model_and_transforms(
        args.model,
        args.pretrained2,
        precision=args.precision,
        device=device,
    ...
    if 'train' not in data:
        ...
        #evaluate_ensemble(model1, model2, data,start_epoch, args, tb_writer=None, tokenizer=None)
        return
    ...
    for epoch in tqdm(range(start_epoch, args.epochs)):
        ...
        if any(v in data for v in ('val', 'imagenet-val', 'imagenet-v2')):
            ...
            #evaluate_ensemble(model1, model2, data,completed_epoch, args, tb_writer=None, tokenizer=None)
